...
\ustcsetup{
  title                = {紧K\"ahler流形上抛物层的 Kobayashi--Hitchin 对应},
  title*               = {Kobayashi--Hitchin Correspondence for Saturated Reflexive Parabolic Sheaves on K\"ahler Manifolds},
  author               = {蒋天枢},
  author*              = {Jiang Tianshu},
  speciality           = {基础数学},
  speciality*          = {Pure Mathematics},
  supervisor           = {李嘉禹教授},
  supervisor*          = {Prof. Li Jiayu},
